...
#include "../../../client/ui/connection.h"
...
QT_MOC_LITERAL(1, 11, 16), // "connectToAddress"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 7), // "address"
QT_MOC_LITERAL(4, 37, 20) // "connectButtonClicked"

    },
    "Connection\0connectToAddress\0\0address\0"
...
void Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->connectToAddress((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Connection::connectToAddress)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Connection::connectToAddress(QString _t1)
{
