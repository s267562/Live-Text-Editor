...
private:
	...
	bool readFileName(QTcpSocket *soc, QMetaObject::Connection *connectReadyRead,
					  QMetaObject::Connection *connectDisconnected);

	void connectSlot(QTcpSocket *soc, QMetaObject::Connection *connectReadyRead,
					 QMetaObject::Connection *connectDisconnected);
...
public slots:
	...
	void readyRead(QTcpSocket *soc, QMetaObject::Connection *c,
				   QMetaObject::Connection *d);                                            // sync
	void
	disconnected(QTcpSocket *socket, qintptr socketDescriptor, QMetaObject::Connection *c,
				 QMetaObject::Connection *d);                 // sync
	void
	saveCRDTToFile();                                                                                                              // sync ok
};
